...
namespace TP.ConcurrentProgramming.BusinessLogic.Test
{
    ...
    public class BusinessLogicImplementationUnitTest
    {
        ...
        public void DisposeTestMethod()
        {
            ...
            Assert.ThrowsException<ObjectDisposedException>(() => newInstance.Start(0, (position, ball, Diameter) => { }));
        ...
        public void StartTestMethod()
        {
            ...
            using (BusinessLogicImplementation newInstance = new(dataLayerFixcure))
            {
                ...
                newInstance.Start(
                  ...
                  (startingPosition, ball, Diameter) => { called++; Assert.IsNotNull(startingPosition); Assert.IsNotNull(ball); });
